google.maps.__gjsload__('drawing_impl', function(_) {
    var L3 = function(a, b) {
        ...
        Q3 = function(a, b) {
            ...
            function c(b, c, h, l) {
                ...
                c = { title: c, b: h, j: l, padding: [0], f: !0 };
                h = _.X("span");
                h.style.display = "inline-block";
                var g = b || "hand",
                    r = M3[g],
                    u = _.lA(d, h, new _.G(0, r), N3);
        ...
        $3 = function(a, b) {
            ...
            if (d) {
                var e = a.get("map"),
                    ...
                    e = e.__gm.get("zoom"),
                    e = a.m / (1 << e),
                    g = f.fromLatLngToPoint(b, a.D);
                b = b.lng();
                var d = c.getAt(d - 1),
                    h = new _.C(d.lat(), _.eb(d.lng(), b - 180, b + 180), !0),
                    h = f.fromLatLngToPoint(h, a.B);
    ...
    _.k.active_changed = function() {
        if (this.get("active")) this.set("draggableCursor", this.m), this.set("draggingCursor", "");
        else {
            var a = this.b;
    ...
    _.Xc("drawing_impl", {
        ...
        ml: function(a) {
            var b = new _.y,
                c = new _.Vt(["dataDrawingMode"], "drawingManagerMode", n4);
